...
class LocationService {
  ...
  static List<Tour> findClosestToursToPosition(List<Tour> tours, Position userPosition, int k) {
  ...
  for (var tour in tours) {
    if (tour.tourDetails.waypoints!.isNotEmpty) {
      double distance = _calculateDistance(userPosition.latitude, userPosition.longitude, tour.tourDetails.waypoints![0].latitude, tour.tourDetails.waypoints![0].longitude);
